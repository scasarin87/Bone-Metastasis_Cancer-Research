...
% This function initializes both boundary and central pc3 blood vessels.
% The idea is to create a vessel distrubution on tumor edge that starts
% from a small dot and grows with the tumor up until their final
% size (major_axis), while in the center generating elliptical vessels
...
function [vessels, single_vessel_masks, center_vessels, vessels_number] = vessels_mask_pc3(rows, columns, tumor, site_dim, X, Y)
