...
save('Results/CaboResults/RENCA/Dose/Linear/25/medium tumorarea cabo25.mat', 'tumor_area');
save('Results/CaboResults/RENCA/Dose/Linear/25/medium bv number cabo25.mat', 'bv_number');
