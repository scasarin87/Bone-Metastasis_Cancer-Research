...
while (epoch < tot_epoch) 
    ...
    name = ['Results/CaboResults/RENCA/Dose/Quadratic/Control/sim',num2str(epoch),'_tumorat1.png'];
    exportgraphics(gcf, name, 'Resolution',1000);
    tumor_at_5 = display_abm(rows, columns, BONE(:,:,5*24), 1);
    name = ['Results/CaboResults/RENCA/Dose/Quadratic/Control/sim',num2str(epoch),'_tumorat5.png'];
    exportgraphics(gcf, name, 'Resolution',1000);
    tumor_at_9 = display_abm(rows, columns, BONE(:,:,9*24), 1);
    name = ['Results/CaboResults/RENCA/Dose/Quadratic/Control/sim',num2str(epoch),'_tumorat9.png'];
    exportgraphics(gcf, name, 'Resolution',1000);
    tumor_at_12 = display_abm(rows, columns, BONE(:,:,12*24), 1);
    name = ['Results/CaboResults/RENCA/Dose/Quadratic/Control/sim',num2str(epoch),'_tumorat12.png'];
    exportgraphics(gcf, name, 'Resolution',1000);
    tumor_at_15 = display_abm(rows, columns, BONE(:,:,15*24), 1);
    name = ['Results/CaboResults/RENCA/Dose/Quadratic/Control/sim',num2str(epoch),'_tumorat15.png'];
    exportgraphics(gcf, name, 'Resolution',1000);
...
save('Results/CaboResults/RENCA/Dose/Quadratic/Control/medium tumorarea Control.mat', 'tumor_area');
save('Results/CaboResults/RENCA/Dose/Quadratic/Control/medium bv number Control.mat', 'bv_number');
